...
execute if score #gamemode_random_pvp_2team_protect value matches 1 run setblock ~-1 ~ ~1 minecraft:gold_block
execute unless score #gamemode_random_pvp_2team_protect value matches 1 run setblock ~-1 ~ ~1 minecraft:smooth_stone
...
setblock ~ ~ ~ minecraft:birch_wall_sign{Text1:'{"text":"------------------","color":"black","clickEvent":{"action":"run_command","value":""}}',Text2:'{"text":"決定","bold":true,"color":"black","clickEvent":{"action":"run_command","value":""}}',Text3:'{"text":"右クリック","color":"black","clickEvent":{"action":"run_command","value":""}}',Text4:'{"text":"------------------","color":"black","clickEvent":{"action":"run_command","value":"function ex3:lobby/menu/parts/gamemode/pvp/2team/protect/select"}}'}

setblock ~-1 ~ ~ minecraft:birch_wall_sign{Text1:'{"text":"------------------","color":"black","clickEvent":{"action":"run_command","value":""}}',Text2:'{"text":"ランダムに含む","bold":true,"color":"black","clickEvent":{"action":"run_command","value":""}}',Text3:'{"text":"右クリック","color":"black","clickEvent":{"action":"run_command","value":""}}',Text4:'{"text":"------------------","color":"black","clickEvent":{"action":"run_command","value":"function ex3:lobby/menu/parts/gamemode/pvp/2team/protect/random_toggle"}}'}


setblock ~-2 ~ ~ minecraft:birch_wall_sign{Text1:'{"text":"------------------","color":"black","clickEvent":{"action":"run_command","value":""}}',Text2:'{"text":"制限時間設定","bold":true,"color":"black","clickEvent":{"action":"run_command","value":""}}',Text3:'["",{"score":{"name":"#gamemode_pvp_2team_protect_time","objective":"value"},"color":"black"},{"text":"分","color":"black"}]',Text4:'{"text":"------------------","color":"black","clickEvent":{"action":"run_command","value":"execute positioned ~ ~ ~ run function ex3:lobby/menu/parts/gamemode/pvp/2team/protect/time_limit/setting"}}'}
