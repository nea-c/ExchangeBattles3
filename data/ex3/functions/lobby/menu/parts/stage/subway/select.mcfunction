...
tellraw @a ["",{"text":"[システム]","color":"yellow"},{"text":" "},{"text":"ステージ","color":"green"},{"text":"を"},{"text":"地下鉄","color":"light_purple"},{"text":"に設定しました"}]
scoreboard players set #setting_stage value 1
