...
execute if score #stage_random_subway value matches 1 run setblock ~-1 ~ ~1 minecraft:gold_block
execute unless score #stage_random_subway value matches 1 run setblock ~-1 ~ ~1 minecraft:smooth_stone
