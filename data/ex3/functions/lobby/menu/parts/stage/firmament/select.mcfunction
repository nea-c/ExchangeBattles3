...
tellraw @a ["",{"text":"[システム]","color":"yellow"},{"text":" "},{"text":"ステージ","color":"green"},{"text":"を"},{"text":"ファーマメント","color":"light_purple"},{"text":"に設定しました"}]
scoreboard players set #setting_stage value 3
