...
tellraw @a ["",{"text":"[システム]","color":"yellow"},{"text":" "},{"text":"チームアーマー","color":"green"},{"text":"を"},{"text":"なし","color":"light_purple"},{"text":"に設定しました"}]
scoreboard players set #setting_team_armor value 0
