...
tellraw @a ["",{"text":"[システム]","color":"yellow"},{"text":" "},{"text":"自然回復","color":"green"},{"text":"を"},{"text":"オフ","color":"light_purple"},{"text":"に設定しました"}]
scoreboard players set #setting_regeneration value 0
