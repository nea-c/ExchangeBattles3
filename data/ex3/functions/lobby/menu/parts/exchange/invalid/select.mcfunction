...
tellraw @a ["",{"text":"[システム]","color":"yellow"},{"text":" "},{"text":"エクスチェンジ","color":"green"},{"text":"を"},{"text":"無効","color":"light_purple"},{"text":"に設定しました"}]
scoreboard players set #setting_exchange value 4
