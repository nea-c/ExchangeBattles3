...
tellraw @a ["",{"text":"[システム]","color":"yellow"},{"text":" "},{"text":"タイムオーバー","color":"green"},{"text":"を"},{"text":"終了","color":"light_purple"},{"text":"に設定しました"}]
scoreboard players set #setting_timeover value 1
