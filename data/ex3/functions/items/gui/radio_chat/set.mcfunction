...
scoreboard players operation #page value = @s radio_chat_page
...
function ex3:items/gui/radio_chat/page_item
...
execute if score @s radio_chat_page matches 2.. run loot replace block 0 0 0 container.3 loot ex3:items/page/back
execute if score @s radio_chat_page matches ..1 run loot replace block 0 0 0 container.5 loot ex3:items/page/next
