#スキル
scoreboard players operation #page value = @s weapon_page
...
function ex3:items/gui/weapon/page_item
...
execute if score @s weapon_page matches 2.. run loot replace block 0 0 0 container.3 loot ex3:items/page/back
execute if score @s weapon_page matches ..0 run loot replace block 0 0 0 container.5 loot ex3:items/page/next
