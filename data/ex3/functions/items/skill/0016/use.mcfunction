...
summon minecraft:bat ~ ~ ~ {Tags:["skill16-bullet","no1","this","no_entity","fixed","death-owner-end"],Silent:1b,Invulnerable:1b,ActiveEffects:[{Id:14b,Amplifier:0b,Duration:1000000,ShowParticles:0b}]}
summon minecraft:bat ~ ~ ~ {Tags:["skill16-bullet","no2","this","no_entity","fixed","death-owner-end"],Silent:1b,Invulnerable:1b,ActiveEffects:[{Id:14b,Amplifier:0b,Duration:1000000,ShowParticles:0b}]}
summon minecraft:bat ~ ~ ~ {Tags:["skill16-bullet","no3","this","no_entity","fixed","death-owner-end"],Silent:1b,Invulnerable:1b,ActiveEffects:[{Id:14b,Amplifier:0b,Duration:1000000,ShowParticles:0b}]}
