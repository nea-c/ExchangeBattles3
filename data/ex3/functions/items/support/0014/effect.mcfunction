...
execute if entity @s[tag=support14.before] run attribute @s generic.movement_speed modifier add 0-0-0-2-0014 "support14" 0.20 multiply
...
execute if entity @s[tag=support14.hasweaponB,tag=!support14.hasweapon] at @s run summon area_effect_cloud ~ ~ ~ {Particle:"dust 0 0 0 0",Radius:0f,WaitTime:1,Duration:5,Age:4,Effects:[{Id:4,Amplifier:19b,Duration:8,ShowIcon:0b,ShowParticles:0b},{Id:18,Amplifier:9b,Duration:8,ShowIcon:0b,ShowParticles:0b}]}
