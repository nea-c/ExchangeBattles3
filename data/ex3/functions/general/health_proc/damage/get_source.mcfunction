execute if entity @s[advancements={ex3:general/attack/melee_dealt=true}] store result score #damage_source value run data get entity @s SelectedItem.tag.CustomModelData 1
...
execute if entity @s[advancements={ex3:general/attack/melee_dealt=true},tag=flag2] if score #damage_source value matches 10004..10005 run tag @s remove flag2

execute if entity @s[advancements={ex3:general/attack/melee_dealt=true}] if score #damage_source value matches 20005 run tag @s add flag2
...
execute if entity @s[advancements={ex3:general/attack/melee_dealt=false}] if score #damage_source value matches 30000..39999 run tag @s add flag2
